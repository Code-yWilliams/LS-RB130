# Write a method called none? that behaves similarly to Enumerable#none? for Arrays.
# It should take an Array as an argument, and a block. It should return true if the
# block returns false for all of the element values. Otherwise, it should return false.
